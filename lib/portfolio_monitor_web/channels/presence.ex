defmodule PortfolioMonitorWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule PortfolioMonitor.MyChannel do
  ...
  """
  use Phoenix.Presence, otp_app: :portfolio_monitor,
                        pubsub_server: PortfolioMonitor.PubSub
end
