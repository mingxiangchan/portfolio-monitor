defmodule ExBitmex.Rest.HTTPClient do
  ...
  @spec auth_request(verb, path, credentials, params, bool) :: auth_response
  def auth_request(verb, path, credentials, params, is_testnet) do
    body = Jason.encode!(params)
  ...
  @spec non_auth_get(path, params, bool) :: non_auth_response
  def non_auth_get(path, params, is_testnet) do
    non_auth_request(:get, path, params, is_testnet)
  end

  @spec non_auth_request(verb, path, params, bool) :: non_auth_response
  def non_auth_request(verb, path, params, is_testnet) do
    body = Jason.encode!(params)
    headers = [] |> put_content_type(:json)
  ...
  def url(path, is_testnet) do
    case is_testnet do
      true -> "https://testnet.bitmex.com/api/v1" <> path
      false -> "https://www.bitmex.com/api/v1" <> path
    end
  end
